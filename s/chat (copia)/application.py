...
def logout():
    ...
    try:
        ...
        return render_template("error.html", error_message="ingrese nombre de usuario")
    else:
...
def chatroomlist():
    ...
    if request.method=="GET" and "user_name" not in session:
        return render_template("error.html", error_message="Ingrese su id prfavor.")
...
def chatroom(chat_id):
    ...
    if request.method == "POST":
        ...
        if chatroom_name in chatlist:
            return render_template("error.html", error_message="Este nombre ya esta en uso.")
    ...
    if request.method == "GET":
        if "user_name" not in session:
            return render_template("error.html", error_message="Porfavor ingrese su usuario.")
        if len(chatlist) < chat_id:
            return render_template("error.html", error_message="Esta sala no existe."
                                                               " Si desea,regrese y creela")
